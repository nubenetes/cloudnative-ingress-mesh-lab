...
> [!NOTE]
> **Multilingual Audio Settings:** All video masterclasses and shorts support **YouTube Multilingual Audio Tracks** / auto-dubbing (up to 21 languages available via player **Settings (⚙️) ➔ Audio track**). The original audio language corresponds to the primary title language: videos with titles in English have **original English audio 🇺🇸**, and videos with titles in Spanish have **original Spanish audio 🇪🇸**.
